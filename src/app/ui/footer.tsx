            ...
            >
                <div className="flex justify-between items-center md:flex-nowrap flex-wrap">
                    ...
                    <div className="flex md:block items-center">
                        <input type="text" placeholder="Aquí coloca tu correo" className="bg-transparent placeholder:pl-0 pl-5 px-2 md:px-10 md:py-3 py-3 mr-5 md:mr-10 rounded-full border border-opacity-10 outline-none border-solid border-[#fff] md:bg-[#8630E0] text-[#fff] placeholder:text-[#fff]" />
                        <button className="md:bg-[#fff] text-[#fff] bg:transparent border-opacity-35 border border-solid border-[#fff]  md:text-[#8F2CE2] px-6 md:px-10 py-3 md:py-3 rounded-full">Solicitar demo</button>
                    </div>
                </div>
                ...
                <div className="text-center md:text-left">
                    <p className="mt-10 opacity-95 text-[#fff]">© 2025 XCode.Inc .Terminos y Condiciones</p>
                </div>
            </div>
