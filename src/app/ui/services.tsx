        ...
        <div>
            ...
            <div id="service" className='px-5 md:pt-10 pt-0 md:px-0 block md:flex xl:max-w-screen-xl mx-auto md:max-w-screen-md xl:flex-nowrap md:flex-wrap mt-20 xl:mt-40 2xl:mt-10 justify-between items-end relative'>
                <div>
                    ...
                    <h4 className='font-bold w-full xl:text-[70px] text-[45px] md:w-[800px] leading-[60px] md:text-[60px]'>Explora lo posible con soluciones digitales a tu medida</h4>
                </div>
                <p className='mt-5 w-[430px] text-[21px] text-[#767676] md:text-[20px] md:mt-5 md:w-[600px]'>Descubre nuestras soluciones diseñadas para impulsar tu marca, acelerar tu crecimiento y dejar huella en el mundo digital.</p>
            </div>
